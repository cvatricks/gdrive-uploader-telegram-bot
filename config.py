...
class Config:
  ...
  if ENV:
    BOT_TOKEN = os.environ.get('1325554549:AAGixaq5YaM4RcgIefJ3Ll9vSAMB7f8LuBQ')
    APP_ID = os.environ.get('1452912')
    API_HASH = os.environ.get('a15b90b055bae417d2c0a6f702e413b1')
    DATABASE_URL = os.environ.get('DATABASE_URL')
  else:
    BOT_TOKEN = '1325554549:AAGixaq5YaM4RcgIefJ3Ll9vSAMB7f8LuBQ' # Get it from https://t.me/BotFather
    APP_ID = '1452912' # Get it from my.telegram.org/apps
    API_HASH = 'a15b90b055bae417d2c0a6f702e413b1' # Get it from my.telegram.org/apps
